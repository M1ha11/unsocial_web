...
RSpec.configure do |config|
 ...
 # Start an in-memory cluster for Elasticsearch as needed
  config.before :all, elasticsearch: true do
    Elasticsearch::Extensions::Test::Cluster.start(command: '/home/antonkomosko/elasticsearch-5.4.3/bin/elasticsearch', port: 9250, nodes: 1, timeout: 120) unless Elasticsearch::Extensions::Test::Cluster.running?(on: 9250)
  end

  # Stop elasticsearch cluster after test run
  config.after :suite do
    Elasticsearch::Extensions::Test::Cluster.stop(command: '/home/antonkomosko/elasticsearch-5.4.3/bin/elasticsearch', port: 9250, nodes: 1) if Elasticsearch::Extensions::Test::Cluster.running?(on: 9250, command: '/home/antonkomosko/elasticsearch-5.4.3/bin/elasticsearch')
  end
