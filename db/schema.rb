...
ActiveRecord::Schema.define(version: 20170717132342) do
  ...
  create_table "interrelationships", force: :cascade do |t|
    t.integer  "follower_id"
    t.integer  "followed_id"
    t.datetime "created_at",  null: false
    t.datetime "updated_at",  null: false
    t.index ["followed_id"], name: "index_interrelationships_on_followed_id", using: :btree
    t.index ["follower_id", "followed_id"], name: "index_interrelationships_on_follower_id_and_followed_id", unique: true, using: :btree
    t.index ["follower_id"], name: "index_interrelationships_on_follower_id", using: :btree
  end
